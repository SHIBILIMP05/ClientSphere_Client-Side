...
const Navbar = (props: dashboardPorpesInterface) => {
    ...
    }, [props.dashboard, props.employee, props.AllSales, props.messenger]);
        ...
        <div className="bg-B4 flex justify-between items-center p-4 shadow-md ">
            ...
            <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-2">
                    <img src={`https://ui-avatars.com/api/?name=${'shibili mp'}&background=random}`} alt="Admin" className="w-8 h-8 rounded-full" />
                    <div className="text-sm">Head Roy</div>
                </div>
            </div>
        </div>
    );
